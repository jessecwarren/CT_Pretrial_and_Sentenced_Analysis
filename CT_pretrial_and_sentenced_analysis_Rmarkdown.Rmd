...
```{r prepare merged data for cluster analysis}
#clean up names
...
```{r cluster analysis}
#create new df to manipulate just for cluster analysis
...
k1 <- kmeans(CT_analysis_merged_cleaned_cluster[, c("sentence_days", "sentenced", "pretrial_detention_length")], centers = 5)
fviz_cluster(k1, data = CT_analysis_merged_cleaned_cluster[, c("sentence_days", "sentenced", "pretrial_detention_length")])
